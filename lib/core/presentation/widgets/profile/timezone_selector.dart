...
List<TimezoneData> getAllTimezones() {
  return [
    ...
    // North America
    const TimezoneData(iana: 'America/New_York', city: 'New York', offset: 'UTC-5/-4'),
    const TimezoneData(iana: 'America/Los_Angeles', city: 'Los Angeles', offset: 'UTC-8/-7'),
    const TimezoneData(iana: 'America/Chicago', city: 'Chicago', offset: 'UTC-6/-5'),
    const TimezoneData(iana: 'America/Denver', city: 'Denver', offset: 'UTC-7/-6'),
    const TimezoneData(iana: 'America/Toronto', city: 'Toronto', offset: 'UTC-5/-4'),
    const TimezoneData(iana: 'America/Vancouver', city: 'Vancouver', offset: 'UTC-8/-7'),
    const TimezoneData(iana: 'America/Montreal', city: 'Montreal', offset: 'UTC-5/-4'),
    const TimezoneData(iana: 'America/Mexico_City', city: 'Mexico City', offset: 'UTC-6/-5'),
    const TimezoneData(iana: 'America/Phoenix', city: 'Phoenix', offset: 'UTC-7'),
    const TimezoneData(iana: 'America/Anchorage', city: 'Anchorage', offset: 'UTC-9/-8'),

    // South America
    const TimezoneData(iana: 'America/Sao_Paulo', city: 'São Paulo', offset: 'UTC-3'),
    const TimezoneData(iana: 'America/Buenos_Aires', city: 'Buenos Aires', offset: 'UTC-3'),
    const TimezoneData(iana: 'America/Santiago', city: 'Santiago', offset: 'UTC-4/-3'),
    ...
    const TimezoneData(iana: 'America/Caracas', city: 'Caracas', offset: 'UTC-4'),

    // Europe
    const TimezoneData(iana: 'Europe/London', city: 'London', offset: 'UTC+0/+1'),
    const TimezoneData(iana: 'Europe/Paris', city: 'Paris', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Berlin', city: 'Berlin', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Madrid', city: 'Madrid', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Rome', city: 'Rome', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Amsterdam', city: 'Amsterdam', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Brussels', city: 'Brussels', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Zurich', city: 'Zurich', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Vienna', city: 'Vienna', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Prague', city: 'Prague', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Warsaw', city: 'Warsaw', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Stockholm', city: 'Stockholm', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Oslo', city: 'Oslo', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Copenhagen', city: 'Copenhagen', offset: 'UTC+1/+2'),
    const TimezoneData(iana: 'Europe/Helsinki', city: 'Helsinki', offset: 'UTC+2/+3'),
    const TimezoneData(iana: 'Europe/Athens', city: 'Athens', offset: 'UTC+2/+3'),
    const TimezoneData(iana: 'Europe/Istanbul', city: 'Istanbul', offset: 'UTC+3'),
    const TimezoneData(iana: 'Europe/Moscow', city: 'Moscow', offset: 'UTC+3'),
    const TimezoneData(iana: 'Europe/Dublin', city: 'Dublin', offset: 'UTC+0/+1'),
    const TimezoneData(iana: 'Europe/Lisbon', city: 'Lisbon', offset: 'UTC+0/+1'),
    const TimezoneData(iana: 'Europe/Budapest', city: 'Budapest', offset: 'UTC+1/+2'),

    // Asia
    const TimezoneData(iana: 'Asia/Dubai', city: 'Dubai', offset: 'UTC+4'),
    const TimezoneData(iana: 'Asia/Kolkata', city: 'Mumbai (Kolkata)', offset: 'UTC+5:30'),
    const TimezoneData(iana: 'Asia/Shanghai', city: 'Shanghai', offset: 'UTC+8'),
    const TimezoneData(iana: 'Asia/Hong_Kong', city: 'Hong Kong', offset: 'UTC+8'),
    const TimezoneData(iana: 'Asia/Tokyo', city: 'Tokyo', offset: 'UTC+9'),
    const TimezoneData(iana: 'Asia/Seoul', city: 'Seoul', offset: 'UTC+9'),
    const TimezoneData(iana: 'Asia/Singapore', city: 'Singapore', offset: 'UTC+8'),
    ...
    const TimezoneData(iana: 'Asia/Kuala_Lumpur', city: 'Kuala Lumpur', offset: 'UTC+8'),
    const TimezoneData(iana: 'Asia/Taipei', city: 'Taipei', offset: 'UTC+8'),
    // Beijing timezone is handled by Shanghai
    const TimezoneData(iana: 'Asia/Ho_Chi_Minh', city: 'Ho Chi Minh City', offset: 'UTC+7'),

    // Australia & Pacific
    const TimezoneData(iana: 'Australia/Sydney', city: 'Sydney', offset: 'UTC+10/+11'),
    const TimezoneData(iana: 'Australia/Melbourne', city: 'Melbourne', offset: 'UTC+10/+11'),
    const TimezoneData(iana: 'Australia/Brisbane', city: 'Brisbane', offset: 'UTC+10'),
    const TimezoneData(iana: 'Australia/Perth', city: 'Perth', offset: 'UTC+8'),
    const TimezoneData(iana: 'Australia/Adelaide', city: 'Adelaide', offset: 'UTC+9:30/+10:30'),
    const TimezoneData(iana: 'Australia/Darwin', city: 'Darwin', offset: 'UTC+9:30'),
    const TimezoneData(iana: 'Pacific/Auckland', city: 'Auckland', offset: 'UTC+12/+13'),
    const TimezoneData(iana: 'Pacific/Fiji', city: 'Fiji', offset: 'UTC+12/+13'),
    const TimezoneData(iana: 'Pacific/Guam', city: 'Guam', offset: 'UTC+10'),

    // Africa
    const TimezoneData(iana: 'Africa/Cairo', city: 'Cairo', offset: 'UTC+2'),
    const TimezoneData(iana: 'Africa/Johannesburg', city: 'Johannesburg (Cape Town)', offset: 'UTC+2'),
    const TimezoneData(iana: 'Africa/Lagos', city: 'Lagos', offset: 'UTC+1'),
    const TimezoneData(iana: 'Africa/Casablanca', city: 'Casablanca', offset: 'UTC+0/+1'),
    const TimezoneData(iana: 'Africa/Nairobi', city: 'Nairobi', offset: 'UTC+3'),

    // Middle East
    const TimezoneData(iana: 'Asia/Tel_Aviv', city: 'Tel Aviv', offset: 'UTC+2/+3'),
    const TimezoneData(iana: 'Asia/Jerusalem', city: 'Jerusalem', offset: 'UTC+2/+3'),
    const TimezoneData(iana: 'Asia/Riyadh', city: 'Riyadh', offset: 'UTC+3'),
    const TimezoneData(iana: 'Asia/Kuwait', city: 'Kuwait', offset: 'UTC+3'),
    const TimezoneData(iana: 'Asia/Tehran', city: 'Tehran', offset: 'UTC+3:30/+4:30'),
    ...
    const TimezoneData(iana: 'Asia/Colombo', city: 'Colombo', offset: 'UTC+5:30'),
    const TimezoneData(iana: 'Atlantic/Reykjavik', city: 'Reykjavik', offset: 'UTC+0'),
    const TimezoneData(iana: 'America/Barbados', city: 'Barbados', offset: 'UTC-4'),
    const TimezoneData(iana: 'Atlantic/Bermuda', city: 'Bermuda', offset: 'UTC-4/-3'),
    const TimezoneData(iana: 'America/Cayman', city: 'Cayman Islands', offset: 'UTC-5'),
    const TimezoneData(iana: 'America/Aruba', city: 'Aruba', offset: 'UTC-4'),
    const TimezoneData(iana: 'Pacific/Honolulu', city: 'Honolulu', offset: 'UTC-10'),
  ];
}
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              initialValue: _filteredTimezones.any((tz) => tz.iana == currentTimezone)
                  ? currentTimezone
                  : null,
              decoration: InputDecoration(
                ...
                enabled: !_isUpdating && !_autoSyncEnabled,
                labelText: _filteredTimezones.isEmpty ? 'No timezones found' : 'Select timezone',
