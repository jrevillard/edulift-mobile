...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<String> sendMagicLink(MagicLinkRequest request) async {
  ...
  Future<AuthDto> verifyMagicLink(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'inviteCode': inviteCode};
  ...
  @override
  Future<AuthDto> refreshToken(RefreshTokenRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthConfigDto> getAuthConfig() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AuthConfigDto>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AuthConfigDto _value;
    try {
      _value = AuthConfigDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UserExistsDto> checkUserExists(String email) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'email': email};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserExistsDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auth/users/exists',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserExistsDto _value;
    try {
      _value = UserExistsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
