...
extension ApiResponsePatterns<T> on ApiResponse<T> {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool success, T? data, String? errorMessage,
            String? errorCode, int? statusCode, Map<String, dynamic> metadata)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiResponse() when $default != null:
        return $default(_that.success, _that.data, _that.errorMessage,
            _that.errorCode, _that.statusCode, _that.metadata);
      case _:
        return orElse();
    }
  }
