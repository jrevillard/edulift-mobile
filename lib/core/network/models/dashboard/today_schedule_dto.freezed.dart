...
mixin _$TodayScheduleDto {
  ...
  $TodayScheduleDtoCopyWith<TodayScheduleDto> get copyWith =>
      _$TodayScheduleDtoCopyWithImpl<TodayScheduleDto>(
          this as TodayScheduleDto, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, time, destination,
...
abstract mixin class $TodayScheduleDtoCopyWith<$Res> {
  factory $TodayScheduleDtoCopyWith(
          TodayScheduleDto value, $Res Function(TodayScheduleDto) _then) =
      _$TodayScheduleDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String time,
...
extension TodayScheduleDtoPatterns on TodayScheduleDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TodayScheduleDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String time, String destination,
    ...
    switch (_that) {
      case _TodayScheduleDto() when $default != null:
        return $default(_that.id, _that.time, _that.destination,
...
class _TodayScheduleDto implements TodayScheduleDto {
  ...
  factory _TodayScheduleDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TodayScheduleDtoCopyWith<_TodayScheduleDto> get copyWith =>
      __$TodayScheduleDtoCopyWithImpl<_TodayScheduleDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TodayScheduleDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$TodayScheduleDtoCopyWith<$Res>
    implements $TodayScheduleDtoCopyWith<$Res> {
  factory _$TodayScheduleDtoCopyWith(
          _TodayScheduleDto value, $Res Function(_TodayScheduleDto) _then) =
      __$TodayScheduleDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$TodayScheduleListDto {
  List<TodayScheduleDto> get schedules;
  String get date;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TodayScheduleListDtoCopyWith<TodayScheduleListDto> get copyWith =>
      _$TodayScheduleListDtoCopyWithImpl<TodayScheduleListDto>(
          this as TodayScheduleListDto, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(schedules), date);
...
abstract mixin class $TodayScheduleListDtoCopyWith<$Res> {
  factory $TodayScheduleListDtoCopyWith(TodayScheduleListDto value,
          $Res Function(TodayScheduleListDto) _then) =
      _$TodayScheduleListDtoCopyWithImpl;
  @useResult
  $Res call({List<TodayScheduleDto> schedules, String date});
}
...
extension TodayScheduleListDtoPatterns on TodayScheduleListDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TodayScheduleListDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<TodayScheduleDto> schedules, String date)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TodayScheduleListDto() when $default != null:
        return $default(_that.schedules, _that.date);
      case _:
        return orElse();
    }
  }
...
class _TodayScheduleListDto implements TodayScheduleListDto {
  const _TodayScheduleListDto(
      {required final List<TodayScheduleDto> schedules, required this.date})
      : _schedules = schedules;
  factory _TodayScheduleListDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TodayScheduleListDtoCopyWith<_TodayScheduleListDto> get copyWith =>
      __$TodayScheduleListDtoCopyWithImpl<_TodayScheduleListDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TodayScheduleListDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TodayScheduleListDto &&
            const DeepCollectionEquality()
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_schedules), date);
...
/// @nodoc
abstract mixin class _$TodayScheduleListDtoCopyWith<$Res>
    implements $TodayScheduleListDtoCopyWith<$Res> {
  factory _$TodayScheduleListDtoCopyWith(_TodayScheduleListDto value,
          $Res Function(_TodayScheduleListDto) _then) =
      __$TodayScheduleListDtoCopyWithImpl;
  @override
  @useResult
  $Res call({List<TodayScheduleDto> schedules, String date});
}
