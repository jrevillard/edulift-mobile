...
mixin _$AuthUserProfileDto {
  ...
  $AuthUserProfileDtoCopyWith<AuthUserProfileDto> get copyWith =>
      _$AuthUserProfileDtoCopyWithImpl<AuthUserProfileDto>(
          this as AuthUserProfileDto, _$identity);
...
abstract mixin class $AuthUserProfileDtoCopyWith<$Res> {
  factory $AuthUserProfileDtoCopyWith(
          AuthUserProfileDto value, $Res Function(AuthUserProfileDto) _then) =
      _$AuthUserProfileDtoCopyWithImpl;
  @useResult
  $Res call({UserCurrentFamilyDto data});
...
extension AuthUserProfileDtoPatterns on AuthUserProfileDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AuthUserProfileDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(UserCurrentFamilyDto data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _AuthUserProfileDto implements AuthUserProfileDto {
  ...
  factory _AuthUserProfileDto.fromJson(Map<String, dynamic> json) =>
      _$AuthUserProfileDtoFromJson(json);

  @override
  final UserCurrentFamilyDto data;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AuthUserProfileDtoCopyWith<_AuthUserProfileDto> get copyWith =>
      __$AuthUserProfileDtoCopyWithImpl<_AuthUserProfileDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AuthUserProfileDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AuthUserProfileDtoCopyWith<$Res>
    implements $AuthUserProfileDtoCopyWith<$Res> {
  factory _$AuthUserProfileDtoCopyWith(
          _AuthUserProfileDto value, $Res Function(_AuthUserProfileDto) _then) =
      __$AuthUserProfileDtoCopyWithImpl;
  @override
  @useResult
  $Res call({UserCurrentFamilyDto data});
...
mixin _$AuthConfigDto {
  ...
  String get mockServiceTest;

  /// Create a copy of AuthConfigDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AuthConfigDtoCopyWith<AuthConfigDto> get copyWith =>
      _$AuthConfigDtoCopyWithImpl<AuthConfigDto>(
          this as AuthConfigDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AuthConfigDto &&
            (identical(other.nodeEnv, nodeEnv) || other.nodeEnv == nodeEnv) &&
            ...
            (identical(other.mockServiceTest, mockServiceTest) ||
                other.mockServiceTest == mockServiceTest));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(
      runtimeType, nodeEnv, emailUser, hasCredentials, mockServiceTest);
...
abstract mixin class $AuthConfigDtoCopyWith<$Res> {
  factory $AuthConfigDtoCopyWith(
          AuthConfigDto value, $Res Function(AuthConfigDto) _then) =
      _$AuthConfigDtoCopyWithImpl;
  @useResult
  $Res call(
      {String nodeEnv,
      String emailUser,
      bool hasCredentials,
      String mockServiceTest});
}
...
class _$AuthConfigDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? mockServiceTest = null,
  }) {
    return _then(_self.copyWith(
      nodeEnv: null == nodeEnv
          ? _self.nodeEnv
          : nodeEnv // ignore: cast_nullable_to_non_nullable
              as String,
      ...
      hasCredentials: null == hasCredentials
          ? _self.hasCredentials
          : hasCredentials // ignore: cast_nullable_to_non_nullable
              as bool,
      mockServiceTest: null == mockServiceTest
          ? _self.mockServiceTest
          : mockServiceTest // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
extension AuthConfigDtoPatterns on AuthConfigDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AuthConfigDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String nodeEnv, String emailUser, bool hasCredentials,
            String mockServiceTest)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AuthConfigDto() when $default != null:
        return $default(_that.nodeEnv, _that.emailUser, _that.hasCredentials,
            _that.mockServiceTest);
      case _:
        return orElse();
    }
  }
...
class _AuthConfigDto implements AuthConfigDto {
  const _AuthConfigDto(
      {required this.nodeEnv,
      required this.emailUser,
      required this.hasCredentials,
      required this.mockServiceTest});
  factory _AuthConfigDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AuthConfigDtoCopyWith<_AuthConfigDto> get copyWith =>
      __$AuthConfigDtoCopyWithImpl<_AuthConfigDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AuthConfigDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AuthConfigDtoCopyWith<$Res>
    implements $AuthConfigDtoCopyWith<$Res> {
  factory _$AuthConfigDtoCopyWith(
          _AuthConfigDto value, $Res Function(_AuthConfigDto) _then) =
      __$AuthConfigDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String nodeEnv,
...
mixin _$UserExistsDto {
  ...
  $UserExistsDtoCopyWith<UserExistsDto> get copyWith =>
      _$UserExistsDtoCopyWithImpl<UserExistsDto>(
          this as UserExistsDto, _$identity);
...
abstract mixin class $UserExistsDtoCopyWith<$Res> {
  factory $UserExistsDtoCopyWith(
          UserExistsDto value, $Res Function(UserExistsDto) _then) =
      _$UserExistsDtoCopyWithImpl;
  @useResult
...
extension UserExistsDtoPatterns on UserExistsDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserExistsDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool exists)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserExistsDto() when $default != null:
        return $default(_that.exists);
      case _:
        return orElse();
    }
  }
...
class _UserExistsDto implements UserExistsDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserExistsDtoCopyWith<_UserExistsDto> get copyWith =>
      __$UserExistsDtoCopyWithImpl<_UserExistsDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UserExistsDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$UserExistsDtoCopyWith<$Res>
    implements $UserExistsDtoCopyWith<$Res> {
  factory _$UserExistsDtoCopyWith(
          _UserExistsDto value, $Res Function(_UserExistsDto) _then) =
      __$UserExistsDtoCopyWithImpl;
  @override
  @useResult
  $Res call({bool exists});
}
...
mixin _$TokenRefreshResponseDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TokenRefreshResponseDtoCopyWith<TokenRefreshResponseDto> get copyWith =>
      _$TokenRefreshResponseDtoCopyWithImpl<TokenRefreshResponseDto>(
          this as TokenRefreshResponseDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TokenRefreshResponseDto &&
...
abstract mixin class $TokenRefreshResponseDtoCopyWith<$Res> {
  factory $TokenRefreshResponseDtoCopyWith(TokenRefreshResponseDto value,
          $Res Function(TokenRefreshResponseDto) _then) =
      _$TokenRefreshResponseDtoCopyWithImpl;
  @useResult
  $Res call(
      {String accessToken,
      String refreshToken,
...
extension TokenRefreshResponseDtoPatterns on TokenRefreshResponseDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TokenRefreshResponseDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _TokenRefreshResponseDto implements TokenRefreshResponseDto {
  const _TokenRefreshResponseDto(
      {required this.accessToken,
      required this.refreshToken,
      required this.expiresIn,
      this.tokenType = 'Bearer'});
  factory _TokenRefreshResponseDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TokenRefreshResponseDtoCopyWith<_TokenRefreshResponseDto> get copyWith =>
      __$TokenRefreshResponseDtoCopyWithImpl<_TokenRefreshResponseDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TokenRefreshResponseDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TokenRefreshResponseDto &&
            (identical(other.accessToken, accessToken) ||
                other.accessToken == accessToken) &&
            (identical(other.refreshToken, refreshToken) ||
                other.refreshToken == refreshToken) &&
...
/// @nodoc
abstract mixin class _$TokenRefreshResponseDtoCopyWith<$Res>
    implements $TokenRefreshResponseDtoCopyWith<$Res> {
  factory _$TokenRefreshResponseDtoCopyWith(_TokenRefreshResponseDto value,
          $Res Function(_TokenRefreshResponseDto) _then) =
      __$TokenRefreshResponseDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String accessToken,
