...
mixin _$FamilyInvitationValidationDto {
  ...
  $FamilyInvitationValidationDtoCopyWith<FamilyInvitationValidationDto>
      get copyWith => _$FamilyInvitationValidationDtoCopyWithImpl<
              FamilyInvitationValidationDto>(
          this as FamilyInvitationValidationDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FamilyInvitationValidationDto &&
            ...
            (identical(other.alreadyMember, alreadyMember) ||
...
abstract mixin class $FamilyInvitationValidationDtoCopyWith<$Res> {
  factory $FamilyInvitationValidationDtoCopyWith(
          FamilyInvitationValidationDto value,
          $Res Function(FamilyInvitationValidationDto) _then) =
      _$FamilyInvitationValidationDtoCopyWithImpl;
  @useResult
  $Res call(
      {bool valid,
      String? familyId,
...
class _$FamilyInvitationValidationDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? requiresAuth = freezed,
    Object? alreadyMember = freezed,
  }) {
    return _then(_self.copyWith(
      ...
      errorCode: freezed == errorCode
          ...
          : errorCode // ignore: cast_nullable_to_non_nullable
              as String?,
      requiresAuth: freezed == requiresAuth
          ? _self.requiresAuth
          : requiresAuth // ignore: cast_nullable_to_non_nullable
              as bool?,
      alreadyMember: freezed == alreadyMember
          ? _self.alreadyMember
          : alreadyMember // ignore: cast_nullable_to_non_nullable
              as bool?,
    ));
  }
}
...
extension FamilyInvitationValidationDtoPatterns
    on FamilyInvitationValidationDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FamilyInvitationValidationDto value)? $default, {
...
class _FamilyInvitationValidationDto implements FamilyInvitationValidationDto {
  const _FamilyInvitationValidationDto(
      {required this.valid,
      this.familyId,
      this.familyName,
      this.inviterName,
      ...
      this.requiresAuth,
      this.alreadyMember});
  factory _FamilyInvitationValidationDto.fromJson(Map<String, dynamic> json) =>
      _$FamilyInvitationValidationDtoFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FamilyInvitationValidationDtoCopyWith<_FamilyInvitationValidationDto>
      get copyWith => __$FamilyInvitationValidationDtoCopyWithImpl<
          _FamilyInvitationValidationDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FamilyInvitationValidationDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FamilyInvitationValidationDto &&
            (identical(other.valid, valid) || other.valid == valid) &&
            (identical(other.familyId, familyId) ||
                other.familyId == familyId) &&
            (identical(other.familyName, familyName) ||
...
/// @nodoc
abstract mixin class _$FamilyInvitationValidationDtoCopyWith<$Res>
    implements $FamilyInvitationValidationDtoCopyWith<$Res> {
  factory _$FamilyInvitationValidationDtoCopyWith(
          _FamilyInvitationValidationDto value,
          $Res Function(_FamilyInvitationValidationDto) _then) =
      __$FamilyInvitationValidationDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool valid,
...
mixin _$PermissionsDto {
  ...
  $PermissionsDtoCopyWith<PermissionsDto> get copyWith =>
      _$PermissionsDtoCopyWithImpl<PermissionsDto>(
          this as PermissionsDto, _$identity);
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(permissions), role);
...
abstract mixin class $PermissionsDtoCopyWith<$Res> {
  factory $PermissionsDtoCopyWith(
          PermissionsDto value, $Res Function(PermissionsDto) _then) =
      _$PermissionsDtoCopyWithImpl;
  @useResult
  $Res call({List<String> permissions, String role});
}
...
extension PermissionsDtoPatterns on PermissionsDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PermissionsDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> permissions, String role)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _PermissionsDto() when $default != null:
        return $default(_that.permissions, _that.role);
      case _:
        return orElse();
    }
  }
...
class _PermissionsDto implements PermissionsDto {
  const _PermissionsDto(
      {required final List<String> permissions, required this.role})
      : _permissions = permissions;
  factory _PermissionsDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PermissionsDtoCopyWith<_PermissionsDto> get copyWith =>
      __$PermissionsDtoCopyWithImpl<_PermissionsDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PermissionsDtoToJson(
      this,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_permissions), role);
...
/// @nodoc
abstract mixin class _$PermissionsDtoCopyWith<$Res>
    implements $PermissionsDtoCopyWith<$Res> {
  factory _$PermissionsDtoCopyWith(
          _PermissionsDto value, $Res Function(_PermissionsDto) _then) =
      __$PermissionsDtoCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> permissions, String role});
}
