...
mixin _$FamilyMemberDto {
  ...
  $FamilyMemberDtoCopyWith<FamilyMemberDto> get copyWith =>
      _$FamilyMemberDtoCopyWithImpl<FamilyMemberDto>(
          this as FamilyMemberDto, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, familyId, role, joinedAt, user);
...
abstract mixin class $FamilyMemberDtoCopyWith<$Res> {
  factory $FamilyMemberDtoCopyWith(
          FamilyMemberDto value, $Res Function(FamilyMemberDto) _then) =
      _$FamilyMemberDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String userId,
...
extension FamilyMemberDtoPatterns on FamilyMemberDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FamilyMemberDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String userId, String familyId, String role,
            DateTime joinedAt, UserDto? user)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FamilyMemberDto() when $default != null:
        return $default(_that.id, _that.userId, _that.familyId, _that.role,
            _that.joinedAt, _that.user);
      case _:
        return orElse();
    }
  }
...
class _FamilyMemberDto extends FamilyMemberDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FamilyMemberDtoCopyWith<_FamilyMemberDto> get copyWith =>
      __$FamilyMemberDtoCopyWithImpl<_FamilyMemberDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FamilyMemberDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FamilyMemberDtoCopyWith<$Res>
    implements $FamilyMemberDtoCopyWith<$Res> {
  factory _$FamilyMemberDtoCopyWith(
          _FamilyMemberDto value, $Res Function(_FamilyMemberDto) _then) =
      __$FamilyMemberDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
