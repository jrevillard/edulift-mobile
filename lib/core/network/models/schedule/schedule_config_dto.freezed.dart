...
// Core ScheduleConfig fields from API
  String get id;
  String get groupId;
  Map<String, List<String>> get scheduleHours;
  DateTime? get createdAt;
  DateTime? get updatedAt; // Relations from API includes (nested objects)
  ...
  $ScheduleConfigDtoCopyWith<ScheduleConfigDto> get copyWith =>
      _$ScheduleConfigDtoCopyWithImpl<ScheduleConfigDto>(
          this as ScheduleConfigDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ScheduleConfigDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            const DeepCollectionEquality()
                .equals(other.scheduleHours, scheduleHours) &&
  ...
  int get hashCode => Object.hash(
      ...
      id,
      groupId,
      const DeepCollectionEquality().hash(scheduleHours),
      createdAt,
      updatedAt,
...
abstract mixin class $ScheduleConfigDtoCopyWith<$Res> {
  factory $ScheduleConfigDtoCopyWith(
          ScheduleConfigDto value, $Res Function(ScheduleConfigDto) _then) =
      _$ScheduleConfigDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String groupId,
    ...
    return _then(_self.copyWith(
      ...
      groupId: null == groupId
          ...
          : groupId // ignore: cast_nullable_to_non_nullable
              as String,
      scheduleHours: null == scheduleHours
          ? _self.scheduleHours
          : scheduleHours // ignore: cast_nullable_to_non_nullable
...
extension ScheduleConfigDtoPatterns on ScheduleConfigDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ScheduleConfigDto value)? $default, {
...
class _ScheduleConfigDto extends ScheduleConfigDto {
  const _ScheduleConfigDto(
      {required this.id,
      required this.groupId,
      final Map<String, List<String>> scheduleHours = const {},
      this.createdAt,
      this.updatedAt,
      final Map<String, dynamic>? group,
      this.totalSlots,
      this.isDefault = false})
      : _scheduleHours = scheduleHours,
        _group = group,
        super._();
  factory _ScheduleConfigDto.fromJson(Map<String, dynamic> json) =>
...
// Relations from API includes (nested objects)
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScheduleConfigDtoCopyWith<_ScheduleConfigDto> get copyWith =>
      __$ScheduleConfigDtoCopyWithImpl<_ScheduleConfigDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScheduleConfigDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ScheduleConfigDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            const DeepCollectionEquality()
                .equals(other._scheduleHours, _scheduleHours) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
            (identical(other.updatedAt, updatedAt) ||
                other.updatedAt == updatedAt) &&
  ...
  int get hashCode => Object.hash(
      ...
      id,
      groupId,
      const DeepCollectionEquality().hash(_scheduleHours),
      createdAt,
      updatedAt,
...
/// @nodoc
abstract mixin class _$ScheduleConfigDtoCopyWith<$Res>
    implements $ScheduleConfigDtoCopyWith<$Res> {
  factory _$ScheduleConfigDtoCopyWith(
          _ScheduleConfigDto value, $Res Function(_ScheduleConfigDto) _then) =
      __$ScheduleConfigDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
