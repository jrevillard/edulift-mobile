...
// Core fields from backend API response (EXACT match to API)
  String
      get id; // CRITICAL FIX: scheduleSlotId is NOT sent in nested vehicle assignments
...
// When vehicleAssignments are nested in ScheduleSlot, this field is absent
  ...
  @JsonKey(name: 'seatOverride')
  int? get seatOverride; // Relations from API includes (nested objects)
  ...
  $VehicleAssignmentDtoCopyWith<VehicleAssignmentDto> get copyWith =>
      _$VehicleAssignmentDtoCopyWithImpl<VehicleAssignmentDto>(
          this as VehicleAssignmentDto, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, scheduleSlotId, seatOverride, vehicle);
...
abstract mixin class $VehicleAssignmentDtoCopyWith<$Res> {
  factory $VehicleAssignmentDtoCopyWith(VehicleAssignmentDto value,
          $Res Function(VehicleAssignmentDto) _then) =
      _$VehicleAssignmentDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      @JsonKey(name: 'scheduleSlotId') String? scheduleSlotId,
      @JsonKey(name: 'seatOverride') int? seatOverride,
      VehicleNestedDto vehicle});
...
extension VehicleAssignmentDtoPatterns on VehicleAssignmentDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VehicleAssignmentDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VehicleAssignmentDto() when $default != null:
        return $default(
            _that.id, _that.scheduleSlotId, _that.seatOverride, _that.vehicle);
      case _:
        return orElse();
    }
  }
...
class _VehicleAssignmentDto extends VehicleAssignmentDto {
  const _VehicleAssignmentDto(
      {required this.id,
      @JsonKey(name: 'scheduleSlotId') this.scheduleSlotId,
      @JsonKey(name: 'seatOverride') this.seatOverride,
      required this.vehicle})
      : super._();
  factory _VehicleAssignmentDto.fromJson(Map<String, dynamic> json) =>
...
// Relations from API includes (nested objects)
  @override
  final VehicleNestedDto vehicle;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VehicleAssignmentDtoCopyWith<_VehicleAssignmentDto> get copyWith =>
      __$VehicleAssignmentDtoCopyWithImpl<_VehicleAssignmentDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VehicleAssignmentDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VehicleAssignmentDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.scheduleSlotId, scheduleSlotId) ||
                other.scheduleSlotId == scheduleSlotId) &&
            (identical(other.seatOverride, seatOverride) ||
...
/// @nodoc
abstract mixin class _$VehicleAssignmentDtoCopyWith<$Res>
    implements $VehicleAssignmentDtoCopyWith<$Res> {
  factory _$VehicleAssignmentDtoCopyWith(_VehicleAssignmentDto value,
          $Res Function(_VehicleAssignmentDto) _then) =
      __$VehicleAssignmentDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$VehicleNestedDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $VehicleNestedDtoCopyWith<VehicleNestedDto> get copyWith =>
      _$VehicleNestedDtoCopyWithImpl<VehicleNestedDto>(
          this as VehicleNestedDto, _$identity);
...
abstract mixin class $VehicleNestedDtoCopyWith<$Res> {
  factory $VehicleNestedDtoCopyWith(
          VehicleNestedDto value, $Res Function(VehicleNestedDto) _then) =
      _$VehicleNestedDtoCopyWithImpl;
  @useResult
...
extension VehicleNestedDtoPatterns on VehicleNestedDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VehicleNestedDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _VehicleNestedDto implements VehicleNestedDto {
  const _VehicleNestedDto(
      {required this.id, required this.name, required this.capacity});
  factory _VehicleNestedDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VehicleNestedDtoCopyWith<_VehicleNestedDto> get copyWith =>
      __$VehicleNestedDtoCopyWithImpl<_VehicleNestedDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VehicleNestedDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$VehicleNestedDtoCopyWith<$Res>
    implements $VehicleNestedDtoCopyWith<$Res> {
  factory _$VehicleNestedDtoCopyWith(
          _VehicleNestedDto value, $Res Function(_VehicleNestedDto) _then) =
      __$VehicleNestedDtoCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String name, int capacity});
}
