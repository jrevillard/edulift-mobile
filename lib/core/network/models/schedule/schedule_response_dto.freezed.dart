...
mixin _$ScheduleResponseDto {
  ...
  String get endDate;
  List<ScheduleSlotDto> get scheduleSlots;

  /// Create a copy of ScheduleResponseDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ScheduleResponseDtoCopyWith<ScheduleResponseDto> get copyWith =>
      _$ScheduleResponseDtoCopyWithImpl<ScheduleResponseDto>(
          this as ScheduleResponseDto, _$identity);
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.scheduleSlots, scheduleSlots));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, groupId, startDate, endDate,
      const DeepCollectionEquality().hash(scheduleSlots));
...
abstract mixin class $ScheduleResponseDtoCopyWith<$Res> {
  factory $ScheduleResponseDtoCopyWith(
          ScheduleResponseDto value, $Res Function(ScheduleResponseDto) _then) =
      _$ScheduleResponseDtoCopyWithImpl;
  @useResult
  $Res call(
      {String groupId,
      String startDate,
    ...
    return _then(_self.copyWith(
      ...
      endDate: null == endDate
          ...
          : endDate // ignore: cast_nullable_to_non_nullable
              as String,
      scheduleSlots: null == scheduleSlots
          ? _self.scheduleSlots
          : scheduleSlots // ignore: cast_nullable_to_non_nullable
...
extension ScheduleResponseDtoPatterns on ScheduleResponseDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ScheduleResponseDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String groupId, String startDate, String endDate,
            List<ScheduleSlotDto> scheduleSlots)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ScheduleResponseDto() when $default != null:
        return $default(
            _that.groupId, _that.startDate, _that.endDate, _that.scheduleSlots);
      case _:
        return orElse();
    }
  }
...
class _ScheduleResponseDto extends ScheduleResponseDto {
  const _ScheduleResponseDto(
      {required this.groupId,
      required this.startDate,
      required this.endDate,
      required final List<ScheduleSlotDto> scheduleSlots})
      : _scheduleSlots = scheduleSlots,
        super._();
  factory _ScheduleResponseDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScheduleResponseDtoCopyWith<_ScheduleResponseDto> get copyWith =>
      __$ScheduleResponseDtoCopyWithImpl<_ScheduleResponseDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScheduleResponseDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ScheduleResponseDto &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            (identical(other.startDate, startDate) ||
                other.startDate == startDate) &&
            (identical(other.endDate, endDate) || other.endDate == endDate) &&
            const DeepCollectionEquality()
                .equals(other._scheduleSlots, _scheduleSlots));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, groupId, startDate, endDate,
      const DeepCollectionEquality().hash(_scheduleSlots));
...
/// @nodoc
abstract mixin class _$ScheduleResponseDtoCopyWith<$Res>
    implements $ScheduleResponseDtoCopyWith<$Res> {
  factory _$ScheduleResponseDtoCopyWith(_ScheduleResponseDto value,
          $Res Function(_ScheduleResponseDto) _then) =
      __$ScheduleResponseDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String groupId,
