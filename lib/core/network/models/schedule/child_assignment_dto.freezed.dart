...
mixin _$ChildAssignmentDto {
  ...
  $ChildAssignmentDtoCopyWith<ChildAssignmentDto> get copyWith =>
      _$ChildAssignmentDtoCopyWithImpl<ChildAssignmentDto>(
          this as ChildAssignmentDto, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, id, childId, assignmentId, status, assignedAt, notes);
...
abstract mixin class $ChildAssignmentDtoCopyWith<$Res> {
  factory $ChildAssignmentDtoCopyWith(
          ChildAssignmentDto value, $Res Function(ChildAssignmentDto) _then) =
      _$ChildAssignmentDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String childId,
...
extension ChildAssignmentDtoPatterns on ChildAssignmentDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChildAssignmentDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String childId, String assignmentId,
            String status, DateTime? assignedAt, String? notes)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ChildAssignmentDto() when $default != null:
        return $default(_that.id, _that.childId, _that.assignmentId,
            _that.status, _that.assignedAt, _that.notes);
      case _:
        return orElse();
    }
  }
...
class _ChildAssignmentDto extends ChildAssignmentDto {
  const _ChildAssignmentDto(
      ...
      this.notes})
      : super._();
  factory _ChildAssignmentDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChildAssignmentDtoCopyWith<_ChildAssignmentDto> get copyWith =>
      __$ChildAssignmentDtoCopyWithImpl<_ChildAssignmentDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChildAssignmentDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChildAssignmentDtoCopyWith<$Res>
    implements $ChildAssignmentDtoCopyWith<$Res> {
  factory _$ChildAssignmentDtoCopyWith(
          _ChildAssignmentDto value, $Res Function(_ChildAssignmentDto) _then) =
      __$ChildAssignmentDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
