...
mixin _$VehicleDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, familyId, capacity,
...
extension VehicleDtoPatterns on VehicleDto {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String familyId, int capacity,
    ...
    switch (_that) {
      case _VehicleDto() when $default != null:
        return $default(_that.id, _that.name, _that.familyId, _that.capacity,
            _that.description, _that.createdAt, _that.updatedAt);
      case _:
        return orElse();
    }
  }
