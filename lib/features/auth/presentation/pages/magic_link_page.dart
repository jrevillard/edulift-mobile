...
class _MagicLinkPageState extends ConsumerState<MagicLinkPage> {
  ...
  Future<void> _resendMagicLink() async {
    ...
    await ref
        ...
        .sendMagicLink(widget.email, inviteCode: authState.pendingInviteCode);

    if (mounted) {
      final l10n = AppLocalizations.of(context);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(key: const Key('successMessage'), l10n.magicLinkResent),
