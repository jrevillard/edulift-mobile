...
import 'package:edulift/core/domain/entities/schedule.dart' as schedule_entities;
...
abstract class GroupScheduleRepository {
  ...
  Future<Result<List<schedule_entities.ScheduleSlot>, ApiFailure>> getWeeklySchedule(
    String groupId,
    String week,
  );
  /// Get schedule configuration for a group
  Future<Result<schedule_entities.ScheduleConfig, ApiFailure>> getScheduleConfig(String groupId);
  ...
  Future<Result<List<schedule_entities.ScheduleConflict>, ApiFailure>> checkScheduleConflicts(
    String groupId,
    String vehicleId,
    String week,
    String day,
  ...
  Future<Result<schedule_entities.ScheduleConfig, ApiFailure>> updateScheduleConfig(
    String groupId,
    schedule_entities.ScheduleConfig config,
  );
  /// Reset schedule configuration to defaults
  Future<Result<schedule_entities.ScheduleConfig, ApiFailure>> resetScheduleConfig(
    String groupId,
  );
  ...
  Stream<Result<schedule_entities.ScheduleSlot, ApiFailure>> listenToScheduleUpdates(
    String groupId,
    String week,
  );
  ...
  Future<Result<List<schedule_entities.ScheduleSlot>, ApiFailure>> getGroupSchedules(
    String groupId, {
    DateTime? fromDate,
    DateTime? toDate,
  });
