...
void main() {
  ...
  group('ScheduleGrid Orphan Slot Filtering Tests', () {
    ...
    testWidgets('Should hide slots with times NOT in scheduleConfig', (
      tester,
    ) async {
    ...
    testWidgets('Should show ONLY configured slots, even when API has extras', (
      tester,
    ) async {
    ...
    testWidgets('Should show NOTHING when scheduleConfig is empty', (
      tester,
    ) async {
    ...
    testWidgets('Should filter orphans per-day independently', (tester) async {
