...
void main() {
  ...
  group('ScheduleSlotDto', () {
    group('JSON Deserialization', () {
      test('should deserialize from API response with datetime field', () {
        ...
        final json = {
          ...
          'datetime': '2025-10-14T05:30:00.000Z', // Tuesday at 5:30 UTC (07:30 local)
      ...
      test('CRITICAL FIX: should handle vehicle assignments WITHOUT scheduleSlotId (nested response)', () {
        ...
        expect(dto.vehicleAssignments![0].scheduleSlotId, isNull); // Should be null, not cause error
        ...
        expect(dto.vehicleAssignments![1].scheduleSlotId, isNull); // Should be null, not cause error
        ...
        expect(domain.vehicleAssignments[0].scheduleSlotId, 'cmgo5u4530019ozw6jhns2e1k'); // Injected from parent
        expect(domain.vehicleAssignments[1].scheduleSlotId, 'cmgo5u4530019ozw6jhns2e1k'); // Injected from parent
    ...
    group('Domain Conversion', () {
      test('should convert DTO to domain model with correct day/time/week extraction', () {
        ...
        expect(domain.timeOfDay, TimeOfDayValue(utcDateTime.hour, utcDateTime.minute));
      ...
      test('should handle different days of week correctly', () {
        ...
        for (final (utcDatetime, expectedWeek) in testCases) {
          ...
          expect(domain.dayOfWeek, expectedDay,
              reason: 'Failed for $utcDatetime (expected $expectedDay)');
          expect(domain.week, expectedWeek,
      ...
      test('should handle different times of day correctly', () {
        ...
        for (final utcDatetime in testCases) {
          final expectedTime = TimeOfDayValue(utcDatetime.hour, utcDatetime.minute);
          ...
          expect(domain.timeOfDay, expectedTime,
      ...
      test('should use proper ISO 8601 week calculation', () {
        ...
        final testCases = [
          ...
          (DateTime.utc(2024, 12, 30, 8), '2025-W01'), // Dec 30, 2024 is in week 1 of 2025
      ...
      test('CRITICAL FIX: should distribute flat childAssignments into VehicleAssignments', () {
