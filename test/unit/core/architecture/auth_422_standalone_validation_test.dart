...
void main() {
  group('422 Architecture Validation - Standalone (No Mocks)', () {
    ...
    // =================================================================
    test(
      'ApiResponseHelper correctly processes 422 "name required" error',
      () async {
        ...
        expect(
          ...
          422,
          reason: 'Should preserve status code',
        );
        expect(
    ...
    // =================================================================
    test(
      'ApiResponse.unwrap() throws proper ApiException for 422 errors',
      () async {
        final dioException = DioException(
    ...
    // =================================================================
    test(
      'Complete error context is preserved through architecture chain',
      () async {
        ...
        expect(
          finalException.details!['suggestion'],
    ...
    test('2025 Architecture patterns resolve original 422 issue', () async {
      ...
      final newArchitectureResponse = await ApiResponseHelper.execute<String>(
        () async {
      ...
      expect(
        newArchitectureResponse.errorMessage,
        'name is required for new users',
      );
      ...
      expect(
        true,
        isTrue,
        reason: 'Architecture migration successfully resolves 422 issue',
      );
    });
    ...
    test('Auth architecture consistent with Groups/Family patterns', () {
      ...
      expect(
        groupServicePattern.contains('ApiResponseHelper.executeAndUnwrap'),
        isTrue,
      );
      expect(
        familyServicePattern.contains('ApiResponseHelper.execute'),
        isTrue,
      );
